...
from entities.forms import EntityCollaboratorFormSet
class NewStoryView(CreateView): #(LoginRequiredMixin, UserPassesTestMixin, UserFormKwargsMixin, CreateView):
    """
    Base view for creating or editing stories
    """
