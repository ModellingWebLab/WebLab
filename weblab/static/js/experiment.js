...
{
	var contextLen = staticPath.length;
	if (location.pathname.substr(0, contextLen) != staticPath)
		return null;
...
function render ()
{
	...
	//if (curVersionId)
	//{
		var curFileId = null; //getCurFileId (url);
		var pluginName = null; //getCurPluginName (url);
